...
Я решил сделать, что-то вроде дорожной карты (Roadmap) для изучения языка Python. Возможно, если найдутся желающие дополнять ее, модифицировать и редактировать, то получиться хорошая инструкция. Данная информация полезна тем, кто хочет изучит основы Python.
...
У меня было много попыток стать разработчиком. История об этом тут: (https://github.com/GnuriaN/Python-Roadmap/blob/master/previous_version/README.md). В итоге я устроился на работу и получить должность Junior Software Developer (2018 год).
...
**Мои рекомендации:**
1. Всех лучше для изучения подходит листрибутивы [PyCharm](https://ru.wikipedia.org/wiki/PyCharm) и [Anaconda](https://www.anaconda.com/what-is-anaconda/).
...
P.S. _Она весит у меня на рабочем месте до сих пор._
